...
if len(sys.argv) != 4:
    ...
    print('format: python ', sys.argv[0], ' <path/to/config_file.txt> <path/to/ref_index_profile.txt> <path/to/output_file.h5>')
    sys.exit()

fname_config = sys.argv[1] # Config file (txt file)
fname_nprofile = sys.argv[2] # Refractive index profile (txt file)
fname_output = sys.argv[3] # Output file for Bscan (hdf or h5 file)
