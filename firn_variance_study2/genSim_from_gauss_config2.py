...
def create_spectrum_gauss(fname_config, nprof_data, zprof_data, fname_output_h5):
    # Create TX_Signal - Impulse
    tx_signal_out = create_tx_signal(fname_config)
    tx_signal_out.get_gausspulse_meep()
...
nTx = len(txList)
tx_signal_in = create_spectrum_gauss(fname_config=fname_config,
