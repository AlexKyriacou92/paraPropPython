...
from makeDepthScan import depth_scan_from_hdf, depth_scan_from_txt, depth_scan_from_hdf_IR, depth_scan_from_txt_IR
...
def main(fname_config, fname_pseudo_external = None, fname_nmatrix_external = None, test_mode = False, parallel_mode = True):
    ...
    if ii_gen_complete == 0:
        ...
        if fname_pseudo_external == None:
            ...
            depth_scan_from_txt_IR(fname_config, fname_nprofile=fname_nprofile_pseudo_txt, fname_out=fname_pseudo_output)
    ...
    cmd_prefix = 'python runSimulation2.py '
